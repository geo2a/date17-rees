...
Systems reconfigurability is crucial for a variety of safety critical applications. 
...
%In the our work we introduced a formal model for dynamically reconfigurable control
%systems \cite{mokhov2008conditional} and presented how verification conditions for our
%model can be expressed as SAT-problems \cite{mokhov2008verification}. Our graph-based
%approach combines both advantages of PNs and FSMs are is able of capturing concurrency
%and choice in a compact and efficient way. A lot of changes in the system happens due
%to the environment (plant) changes and the most suitable models for analysing
