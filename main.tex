...
\textsc{Workcraft} using a domain-specific language (DSL) for
...
productivity of REES designers\label{sec:dsl}}
...
\emph{``Synthesis of processor instruction sets from high-level ISA specifications''}. IEEE Transactions on Computers, 63(6), 1552-1566.
